...
<html>
  ...
  <div class="pop_up_products">
      <?php
        ...
        <div id="oo2" style="margin-left:250px;margin-top:-60px;">quantité : <?php echo $usr3['quantité'] ?></div>
        <div id="oo3" style="margin-left:250px;">Color : <?php echo $usr3['color'] ?></div>
      </div>
    </div>
...
while($row = mysqli_fetch_assoc($usr))
{
  ...
  <div class="c">
<div>
  <img src="robes/<?php echo $row['image'] ?>" class="image">
