...
<!--Menu Slider-->
  <div id="MenuSlider">
    ...
    <div id="clothes" style="text-align: center; margin-top: 30px;">
      ...
      <div class="c">
      <div>
        <img src="accessoires/lunettes/0652203400_1_1_2.jpg" class="image">
        <h4>49.90 TND</h4>
        <h6 style="margin-bottom: 35px;">LUNETTES MOTIF ÉCAILLE</h6>
      </div>
      <button class="b">Select</button>
    </div>
    <div class="c">
      <div>
        <img src="accessoires/lunettes/0650203004_2_1_2.jpg" class="image">
        <h4>49.90 TND</h4>
        <h6>LUNETTES CARRÉES AUX</h6>
        <h6>VERRES DÉGRADÉS</h6>
      </div>
      <button class="b">Select</button>
    </div>
    <div class="c">
      <div>
        <img src="accessoires/lunettes/0377003001_1_1_2.jpg" class="image">
        <h4>49.90 TND</h4>
        <h6 style="margin-bottom: 35px;">LUNETTES DE SOLEIL ŒIL DE CHAT</h6>
      </div>
      <button class="b">Select</button>
    </div>
    </div>
    ...
    <div style="margin-top: 10px;">
      <div class="c">
      <div>
        <img src="accessoires/lunettes/3819003530_1_1_2.jpg" class="image">
        <h4>49.90 TND</h4>
        <h6>LUNETTES DE SOLEIL</h6>
        <h6>HEXAGONALES EN MÉTAL</h6>
      </div>
      <button class="b">Select</button>
    </div>
    <div class="c">
      <div>
        <img src="accessoires/lunettes/3818003001_2_1_2.jpg" class="image">
        <h4>49.90 TND</h4>
        <h6>LUNETTES PLASTIQUE AVEC</h6>
        <h6>DÉTAIL MÉTAL</h6>
      </div>
      <button class="b">Select</button>
    </div>
    <div class="c">
      <div>
        <img src="accessoires/lunettes/0660203400_2_2_2.jpg" class="image">
        <h4>49.90 TND</h4>
        <h6 style="margin-bottom: 35px;">LUNETTES RECTANGULAIRES PLASTIQUE</h6>
      </div>
      <button class="b">Select</button>
    </div>
    </div>
