...
<div data-aos="flip-left" data-aos-duration="1500" style="display: flex;">
  ...
  <div id="MenuSlider1">
    ...
    <div id="clothes" style="text-align: center; margin-top: 30px;">
      ...
      <div class="c">
      <div>
        <img src="accessoires/bijoutx/0083204300_1_1_2.jpg" class="image">
        <h4>39.90 TND</h4>
        <h6 style="margin-bottom: 35px;">LOT DE 3 COLLIERS RAS-DE-COU</h6>
      </div>
      <button class="b">Select</button>
    </div>
    <div class="c">
      <div>
        <img src="accessoires/bijoutx/0049405300_1_1_2.jpg" class="image">
        <h4>29.90 TND</h4>
        <h6>LOT 6 PAIRES DE BOUCLES</h6>
        <h6>D’OREILLES BASIQUES</h6>
      </div>
      <button class="b">Select</button>
    </div>
    <div class="c">
      <div>
        <img src="accessoires/bijoutx/0089204300_2_3_2.jpg" class="image">
        <h4>39.90 TND</h4>
        <h6>LOT 4 COLLIERS</h6>
        <h6>MÉDAILLES ET CRISTAUX</h6>
      </div>
      <button class="b">Select</button>
    </div>
    </div>
    ...
    <div style="margin-top: 10px;">
      <div class="c">
      <div>
        <img src="accessoires/bijoutx/0217404300_2_2_2.jpg" class="image">
        <h4>39.90 TND</h4>
        <h6 style="margin-bottom: 35px;">LOT 4 COLLIERS CHARM ET PERLE</h6>
      </div>
      <button class="b">Select</button>
    </div>
    <div class="c">
      <div>
        <img src="accessoires/bijoutx/0041405300_1_1_2.jpg" class="image">
        <h4>29.90 TND</h4>
        <h6>LOT 9 PAIRES DE BOUCLES</h6>
        <h6>D’OREILLES PAPILLON ET ANNEAUX</h6>
      </div>
      <button class="b">Select</button>
    </div>
    <div class="c">
      <div>
        <img src="accessoires/bijoutx/0014405300_2_1_2.jpg" class="image">
        <h4>49.90 TND</h4>
        <h6>PACK 3 PAIRES DE BOUCLES</h6>
        <h6>D’OREILLES PAPILLON ET ANNEAUX</h6>
      </div>
      <button class="b">Select</button>
    </div>
    ...
    <div style="margin-top: 10px;">
      <div class="c">
      <div>
        <img src="accessoires/bijoutx/3110304300_1_1_2.jpg" class="image">
        <h4>39.90 TND</h4>
        <h6 style="margin-bottom: 35px;">LOT DE 4 COLLIERS CŒUR</h6>
      </div>
      <button class="b">Select</button>
    </div>
    <div class="c">
      <div>
        <img src="accessoires/bijoutx/0118411300_2_1_2.jpg" class="image">
        <h4>49.90 TND</h4>
        <h6 style="margin-bottom: 35px;">COLLIER RAS DU COU AVEC NŒUDS</h6>
      </div>
      <button class="b">Select</button>
    </div>
    <div class="c">
      <div>
        <img src="accessoires/bijoutx/0115411300_1_1_2.jpg" class="image">
        <h4>49.90 TND </h4>
        <h6>LOT 2 PAIRES DE BOUCLES</h6>
        <h6>D’OREILLES ANNEAUX ET PERLES</h6>
      </div>
      <button class="b">Select</button>
    </div>
    </div>
