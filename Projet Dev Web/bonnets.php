...
<div data-aos="flip-left" data-aos-duration="1500" style="display: flex;">
  ...
  <div id="MenuSlider1">
    ...
    <div id="clothes" style="text-align: center; margin-top: 30px;">
      ...
      <div class="c">
      <div>
        <img src="accessoires/bonnets/0672411250_2_3_2.jpg" class="image">
        <h4>49.90 TND</h4>
        <h6>CASQUETTE BRODÉE</h6>
      </div>
      <button class="b">Select</button>
    </div>
    <div class="c">
      <div>
        <img src="accessoires/bonnets/3852303501_2_1_2.jpg" class="image">
        <h4>39.90 TND</h4>
        <h6>BONNET LARGE EN MAILLE CÔTELÉE</h6>
      </div>
      <button class="b">Select</button>
    </div>
    <div class="c">
      <div>
        <img src="accessoires/bonnets/0718411701_2_1_2.jpg" class="image">
        <h4>49.90 TND</h4>
        <h6>CASQUETTE EN JEAN</h6>
      </div>
      <button class="b">Select</button>
    </div>
    </div>
    ...
    <div style="margin-top: 10px;">
      <div class="c">
      <div>
        <img src="accessoires/bonnets/3840303004_2_3_2.jpg" class="image">
        <h4>49.90 TND</h4>
        <h6>CASQUETTE DÉLAVÉE SANS MESSAGE</h6>
      </div>
      <button class="b">Select</button>
    </div>
    <div class="c">
      <div>
        <img src="accessoires/bonnets/3843133001_2_3_2.jpg" class="image">
        <h4>49.90 TND</h4>
        <h6>BÉRET BASIQUE</h6>
      </div>
      <button class="b">Select</button>
    ...
    <div class="c">
      <div>
        <img src="accessoires/bonnets/0676411001_2_3_2.jpg" class="image">
        <h4>99.90 TND</h4>
        <h6>CHAPEAU COWBOY</h6>
      </div>
      <button class="b">Select</button>
    </div>
    </div>
