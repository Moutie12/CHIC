...
$aze = "select * from manteaux";
$hey = mysqli_query($connect,$aze);
    ...
    <div class="navbar" style="z-index: 999;">
            ...
            <div>
              ...
              <div class="side-bar" style="display: flex;">
                ...
                <div>
                  <img src="55.jpg" style="width: 940px; height: 100%;">
                </div>
              </div>
            </div>
      ...
      <div class="elements">
        <div class="buttons">
          <img src="log1.png" id="profil" style="width: 30px; height: 30px;" onclick="affichage_buttons()">
...
<div class="pop_up_products" style="height:30%;">
      <?php
...
<div data-aos="flip-left" data-aos-duration="1500" style="display: flex;">
  ...
  <div class="clothes1">
<?php
while($ppo1 = mysqli_fetch_assoc($hey))
{
  ?>
  <div class="c">
<div>
  <img src="coat/<?php echo $ppo1['image'] ?>" class="image">
  <h4><?php echo $ppo1['prix'] ?> TND</h4>
  <h6><?php echo $ppo1['description'] ?></h6>
</div>
<button class="b"><a href="commander.php?id=<?php echo $ppo1['id'] ?>" id="commander">Select</a></button>
</div>
<?php
}
?>   
