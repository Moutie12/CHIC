...
<div data-aos="flip-left" data-aos-duration="1500" style="display: flex;">
  ...
  <div id="MenuSlider1">
    <div class="cat">
      <a href="pantalon.html" style="text-decoration: none; margin-right: 15px;"><button type="button" class="btn-primary" id="submitCategories"><b>Pantalon</b></button> </a>
      <a href="jeans.html" style="text-decoration: none;"><button type="button" class="btn-primary" id="submitCategories"><b>Jeans</b></button>  </a> 
    </div>
    <div class="cat">
      <a href="T_shirt.html" style="text-decoration: none; margin-right: 65px;"><button type="button" class="btn-primary" id="submitCategories"><b>Pull</b></button></a>
      <a href="shoes.html" style="text-decoration: none;"><button type="button" class="btn-primary" id="submitCategories"><b>Chaussures</b></button></a>
    </div>
    <div class="cat">
      <a href="robes.html" style="text-decoration: none;  margin-right: 45px;"><button type="button" class="btn-primary" id="submitCategories"><b>Robes</b></button></a>
      <a href="manteau.html" style="text-decoration: none;"><button type="button" class="btn-primary" id="submitCategories"><b>Manteaux</b></button> </a>
    </div>
    <div class="cat">
      <a href="blazers.html" style="text-decoration: none;  margin-right: 32px;"><button type="button" class="btn-primary" id="submitCategories"><b>Blazers</b></button></a>
      <a href="chemise.html" style="text-decoration: none;"><button type="button" class="btn-primary" id="submitCategories"><b>Chemises</b></button> </a>
    </div>
    <div class="cat">
      <a href="sac.html" style="text-decoration: none; margin-right: -8px;"><button type="button" class="btn-primary" id="submitCategories"><b>Accessoires</b></button></a>
      <a href="talon.html" style="text-decoration: none;"><button type="button" class="btn-primary" id="submitCategories"><b>Talents</b></button></a>
    </div>
  </div>
