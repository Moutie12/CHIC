...
$id = $_GET['id'];
$usr = "select * from accessoire where id=$id";
...
if (isset($_POST['submit']))
{
    ...
    $sql = "UPDATE sac SET prix='$price',description='$description' WHERE id=$id";
...
<body>
    ...
    <div id="wrapper">
        ...
        <img src="../sac/<?php echo $fft['image']?>" id="photo_modifier">
            <div class="aa2a">
