...
$id = $_GET['id'];
$usr = "select * from chaussure where id=$id";
...
if (isset($_POST['submit']))
{
    ...
    $sql = "UPDATE chaussure SET prix='$price',description='$description' WHERE id=$id";
...
<body>
    ...
    <div id="wrapper">
        ...
        <img src="../shoes/<?php echo $fft['image']?>" id="photo_modifier">
            <div class="aa2a">
