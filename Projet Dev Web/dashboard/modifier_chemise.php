...
$id = $_GET['id'];
$usr = "select * from chemise where id=$id";
...
if (isset($_POST['submit']))
{
    ...
    $sql = "UPDATE chemise SET prix='$price',description='$description' WHERE id=$id";
...
<body>
    ...
    <div id="wrapper">
        ...
        <img src="../chemise/<?php echo $fft['image']?>" id="photo_modifier">
            <div class="aa2a">
