...
$id = $_GET['id'];
$usr = "select * from pull where id=$id";
...
if (isset($_POST['submit']))
{
    ...
    $sql = "UPDATE pull SET prix='$price',description='$description' WHERE id=$id";
...
<body>
    ...
    <div id="wrapper">
        ...
        <img src="../T-SHIRT/<?php echo $fft['image']?>" id="photo_modifier">
            <div class="aa2a">
