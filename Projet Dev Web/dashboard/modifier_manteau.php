...
$id = $_GET['id'];
$usr = "select * from manteaux where id=$id";
...
if (isset($_POST['submit']))
{
    ...
    $sql = "UPDATE manteau SET prix='$price',description='$description' WHERE id=$id";
...
<body>
    ...
    <div id="wrapper">
        ...
        <img src="../coat/<?php echo $fft['image']?>" id="photo_modifier">
            <div class="aa2a">
