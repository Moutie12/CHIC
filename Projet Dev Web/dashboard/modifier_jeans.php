...
$id = $_GET['id'];
$usr = "select * from jeans where id=$id";
...
if (isset($_POST['submit']))
{
    ...
    $sql = "UPDATE jeans SET prix='$price',description='$description' WHERE id=$id";
...
<body>
    ...
    <div id="wrapper">
        ...
        <img src="../jeans/<?php echo $fft['image']?>" id="photo_modifier">
            <div class="aa2a">
